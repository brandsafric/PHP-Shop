    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="section-title">
                <h2 class="title" style="">{{ count($products) }} results found for "{{ $search }}"</h2>
                @if(count($products)>0)<h4>Showing results from {{ $from_product+1 }} to {{ $to_product }}</h4>@endif
            </div>
        </div>
        <!-- section title -->
        ...
        <div class="row">
            <div class="col-sm-12 col-md-10">
                <form action="/set-sort-type" method="post" id="form-sort" class="form-horizontal">
                    ...
                    <div class="form-group col-sm-6 col-md-4">
                        <label for="products-per-page" class="col-sm-6 col-md-6 control-label text-right">Products per Page</label>
