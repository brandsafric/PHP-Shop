            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="bs-example bs-example-tabs" data-example-id="togglable-tabs">
                            ...
                            <div class="tab-content" id="myTabContent">
                                ...
                                <div class="tab-pane fade active in" role="tabpanel" id="div-product-picture" aria-labelledby="profile-tab">
                                    <form id="form-product-picture" method="post">
                                        <input type="hidden" name="selected-id-product-picture" value="{{ $product->picture_id }}">
                                        <input type="hidden" name="suffix" value="product-picture">
                                        {!! csrf() !!}
                                    </form>
                                </div>
                            </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" id="save-changes-product-picture" class="btn btn-primary" data-dismiss="modal">Save changes</button>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-md-12">
                        ...
                        @if($pictures)
                            ...
                            <div class="col-md-6" style="padding-left: 0; padding-right: 0;">
                                <img src="{{ $picture->path }}" style="width:100%; padding: 0 5px 3px 0;">
                            </div>
                            @endforeach
                        @endif
                        </div>
    ...
    <script>
        $(document).ready(function(){
            $(document).on('click', '#pictures', function(){
                $("#form-product-picture").submit();
            });

        });
        $('#form-product-picture').on('submit', function(e){
            e.preventDefault();
            $.ajax({
